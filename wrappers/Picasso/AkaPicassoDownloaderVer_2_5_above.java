...
//Picasso 2.5.0 and above
public final class AkaPicassoDownloaderVer_2_5_above implements Downloader {
     ...
     * {@link #AkaPicassoDownloaderVer_2_5_above(Context)}. This allows you to build your own {@link OkHttpClient}
     ...
     * cache directory.
     */
    public AkaPicassoDownloaderVer_2_5_above(Context context) {
     ...
     */
    public AkaPicassoDownloaderVer_2_5_above(File cacheDir) {
     ...
     */
    public AkaPicassoDownloaderVer_2_5_above(final Context context, final long maxSize) {
     ...
     * @param maxSize The size limit for the cache.
     */
    public AkaPicassoDownloaderVer_2_5_above(File cacheDir, long maxSize) {
        this(createOkHttpClient(cacheDir, maxSize));
    }

    public AkaPicassoDownloaderVer_2_5_above(OkHttpClient client) {
        this.client = client;
        this.cache = client.cache();
    }

    public AkaPicassoDownloaderVer_2_5_above(Call.Factory client) {
        this.client = client;
        this.cache = null;
    }
